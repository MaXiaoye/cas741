...
\begin{document}
	...
	\begin{description}
		...
		initial input data.
		\item[\refstepcounter{acnum} \actheacnum \label{acCF}:] The
  ...
  should map to an anticipated change.}
	...
	\begin{description}
		...
		a source of input data external to the software.
              \item[\refstepcounter{ucnum} \uctheucnum \label{ucFri}:] Input
...
\wss{Is Unity an unlikely change?  I cannot remember whether this was a
  ...
  physics engine.}
	...
	\begin{description}
		...
		\item [\refstepcounter{mnum} \mthemnum \label{mOGC}:] Acquiring gravity center Module
		\item [\refstepcounter{mnum} \mthemnum \label{mAC}:] Angle calculation Module
		\item [\refstepcounter{mnum} \mthemnum \label{mDC1}:] Displacement in the air calculation Module
		\item [\refstepcounter{mnum} \mthemnum \label{mDC2}:] Displacement on the ground calculation Module
		\item [\refstepcounter{mnum} \mthemnum \label{mSD}:] Software Decision Module
		\item [\refstepcounter{mnum} \mthemnum \label{mOC}:] Object cutting Module
...
\wss{I would think that your physics engine would be within the software
  ...
  Aren't there other services from Unity that you need?}
	...
	\begin{description}
		...
		input parameters module. \wss{You don't have an input parameters
	...
	\begin{description}
		...
		\item[Services:]Extend existing object class provided by
                  platform to implement object class for piece object.  \wss{The
