...
\begin{enumerate}
	...
	Output: $a = \mu_{k}g$, $S_{x}=v_{0}\cdot cos\theta _{1}\cdot cos\theta _{2}\cdot t-\frac{1}{2}at^{2}$ and $S_{y}=v_{0}\cdot cos\theta _{1}\cdot sin\theta _{2}\cdot t-\frac{1}{2}at^{2}$ \an{Acceleration $a$ is a intermediate result that doesn't need separate module and system test.}
