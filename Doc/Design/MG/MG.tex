...
\begin{document}
	...
	\begin{description}
		...
		initial input data.
		\item[\refstepcounter{acnum} \actheacnum \label{acCF}:] The cutting function provided by Unity3D. 
	\end{description}
	...
	\begin{description}
		...
		\item[\refstepcounter{ucnum} \uctheucnum \label{ucFri}:] In real situation, users may have kinds of terrians and textures.
	...
	\begin{description}
		...
		\item [\refstepcounter{mnum} \mthemnum \label{mOGC}:] Obtaining gravity center module
		\item [\refstepcounter{mnum} \mthemnum \label{mAC}:] Angle calculation module
		\item [\refstepcounter{mnum} \mthemnum \label{mDC1}:] Displacement calculation module one
		\item [\refstepcounter{mnum} \mthemnum \label{mDC2}:] Displacement calculation module two
		\item [\refstepcounter{mnum} \mthemnum \label{mSD}:] Software Decision Module
		\item [\refstepcounter{mnum} \mthemnum \label{mCSC}:] Current speed calculation Module
	...
	\begin{table}[h!]
		...
		\begin{tabular}{p{0.3\textwidth} p{0.6\textwidth}}
			...
			\multirow{3}{0.3\textwidth}{Software Decision Module} & Current speed calculation Module\\
			& Output Module\\
			\bottomrule
	...
	\subsubsection{Current speed calculation Module(\mref{mCSC})}
	
	\begin{description}
		\item[Secrets:] How to calculate speed at the start of each frame.
		\item[Services:] Return speed at the start of each frame.
		% Changes in these modules are more likely to be motivated by a desire to
		% improve performance than by externally imposed changes.
		\item[Implemented By:] Breaking Effect
	\end{description}
	...
	\begin{description}
		...
		% Changes in these modules are more likely to be motivated by a desire to
		% improve performance than by externally imposed changes.
		\item[Implemented By:] Unity3D and Breaking Effect
		\end{description}
	...
	\begin{table}[H]
		...
		\begin{tabular}{p{0.2\textwidth} p{0.6\textwidth}}
			...
			R4 & \mref{mOGC}\\
			R5 & \mref{mAC}\\
			R6 & \mref{mDC1},\mref{mCSC}\\
			R7 & \mref{mDC2},\mref{mCSC}\\
			\bottomrule
		\end{tabular}
