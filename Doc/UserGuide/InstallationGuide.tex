...
\begin{document}
	...
	\begin{enumerate}
		...
		Now it is ready to run the demo. Explosion level is 5 and coefficient of ground friction is 0.2 by defult. Click play button on the top of Unity3d GUI. Press E button on keyboard to start.\\
