...
\begin{document}
	...
	Before explosion, the kinetic energy is zero. potential energy of target object can't be negative. An initial momentum will be assigned to each piece after explosion happens. \wss{You
